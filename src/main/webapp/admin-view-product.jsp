...
<html>
    ...
    <body>
        ...
        <jsp:include page="adminHeader.jsp"></jsp:include>
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pad-botm">
                        <div class="col-md-12">
                            <h4 class="header-line">Voir les produits</h4>
                        </div>
                    </div>
                     <%
                ...
                %>
                <div class="alert alert-success" id="success">Product deleted successfully.</div>
                <%
                    }
                ...
                %>
               <div class="alert alert-danger" id="success">Product not deleted.</div>
                ...
                %>
                <div class="alert alert-success" id="success">Changes have been successfully saved.</div>
                <%
                    }
            ...
            %>
           <div class="alert alert-danger" id="success">Changes not saved.</div>
            <%
                }
            %>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from products order by id DESC");
                                            while (rs.next()) {
                                        %>
                                        <tbody>
                                            <tr>
