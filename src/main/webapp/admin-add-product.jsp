                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" action="AddProducts" method="post"
                                    ...
                                    <div class="form-group">
                                        <label>Stock</label> <input class="form-control" type="number" name="mprice" required/>
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label> 
                                        <select class="form-control" name="status" required>
                                            <option>En stock</option>
                                            <option>En repture de stock</option>
                                        </select>
                                    </div>
                                    <%
                                    Connection con = DatabaseConnection.getConnection();
                                    PreparedStatement st = con.prepareStatement("select name from  categories_tab  ");
