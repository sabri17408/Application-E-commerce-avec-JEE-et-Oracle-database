                    ...
                    <div class="col-md-12">
                        <div class="navbar-collapse collapse ">
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                <li><a href="IndexPrincipale.jsp">Acceuil</a></li>
                                <li><a href="admin-login.jsp">Admin Connexion</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="AdminLogin" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Mot de passe.:</label> <input type="password" name="upass" class="form-control">
                                    </div>
